...
class Enemy(Sprite):
    ...
    image_enemy = {0: ENEMY_1, 1: ENEMY_2, 2: ENEMY_3}

    def __init__(self, SPEED_Y, SPEED_X):
        self.image = self.image_enemy[random.randint(0, 2)]
        ...
        self.index = 0
        self.type = 'enemy'
        self.shooting_time = random.randint(200, 400)  # Ajusta los rangos de tiempo aquí
